...
// index de un vertice
 int GrafoMatriz::indexOfVertice(QString v)
    {
...
// agregar arista
    void GrafoMatriz::agregarArista(QString origen,QString destino,bool activo,double costo,double km, double minutos)
    {
        ...
        if (orig != -1 && dest != -1)
        {
            matriz[dest][orig] = new Arista(origen, destino, activo, costo, km, minutos);
        }
    }
